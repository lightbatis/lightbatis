...
public abstract class JavaScriptLexerBase extends Lexer
{
    ...
    {
        if (lastToken == null || lastToken.getType() == JSVLexer.OpenBrace)
        {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            case JSVLexer.Identifier:
            case JSVLexer.NullLiteral:
            case JSVLexer.BooleanLiteral:
            case JSVLexer.This:
            case JSVLexer.CloseBracket:
            case JSVLexer.CloseParen:
            case JSVLexer.OctalIntegerLiteral:
            case JSVLexer.DecimalLiteral:
            case JSVLexer.HexIntegerLiteral:
            case JSVLexer.StringLiteral:
            case JSVLexer.PlusPlus:
            case JSVLexer.MinusMinus:
