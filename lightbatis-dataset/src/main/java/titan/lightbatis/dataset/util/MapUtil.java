...
public class MapUtil {
    ...
    /**
     * スレッドセーフな{@link HashMap}を作成して返します。
     * <p>
     * 実行環境がJava5の場合は{@link java.util.concurrent.ConcurrentHashMap}を、それ以外の場合は
     * {@link java.util.CollectionUtil#synchronizedMap}でラップされた{@link HashMap}を
     * 返します。
     * </p>
     * 
    ...
    /**
     * スレッドセーフな{@link HashMap}のファクトリです。
     * 
     * @author koichik
     */
    interface MapFactory {
        /**
         * デフォルトの初期容量と負荷係数で{@link HashMap}を作成して返します。
         * 
         * @return スレッドセーフな{@link java.util.HashMap}
         */
        Map create();
        ...
        /**
         * 指定されて初期容量とデフォルトの負荷係数で{@link HashMap}を作成して返します。
         * 
         * @param initialCapacity
         * @return スレッドセーフな{@link java.util.HashMap}
         */
        ...
        /**
         * 指定された初期容量と負荷係数で{@link HashMap}を作成して返します。
         * 
         * @param initialCapacity
         *            初期容量
         * @param loadFactor
