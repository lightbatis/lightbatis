...
public class JDBCTypeMapping {
    ...
    public static final Map<Integer, Class<?>> defaultTypes = new HashMap<Integer, Class<?>>();

    public static final Map<Class<?>, Integer> defaultSqlTypes = new HashMap<Class<?>, Integer>();
