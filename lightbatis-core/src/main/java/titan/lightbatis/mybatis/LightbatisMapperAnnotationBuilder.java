 ...
 *
 */
public class LightbatisMapperAnnotationBuilder extends MapperAnnotationBuilder{
	...
	//使用这些单词开头的都是采用 Select  查询的方法-
	//private final String[] queryPrefix = {"query","list","find","get"};
		...
		if (sqlSource != null) {
			...
			if (SqlCommandType.INSERT.equals(sqlCommandType) || SqlCommandType.UPDATE.equals(sqlCommandType)) {
				...
				if (selectKey != null) {
					...
					//如果没有配置自增长相关的配置，这里如果关键字需要默认一个。
//					if (keyGenerator == null && keyColumn == null) {
//						System.err.println(parameterTypeClass );
//					}
		
					keyGenerator = SnowflakeIdKeyGenerator.INSTANCE;
